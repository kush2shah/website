...
import yosemitestars from '../../assets/digital/a7/yosemitestars.jpeg';
import malaysia from '../../assets/digital/xe4/malaysia.jpeg';
import malaysia2 from '../../assets/digital/xe4/malaysia2.jpeg';
import tunnelview from '../../assets/digital/xe4/tunnelview.jpeg';

import '../../css/photo/photo.scss'

// Animation component for each photo
function AnimatedPhoto({ src, alt, caption, index }: { src: string, alt: string, caption: string, index: number }) {
...
function Digital() {
    const photos = [
        ...
        { src: yosemitestars, alt: "Yosemite stars", caption: "Sony a7R III + FE 24-70 f/2.8 GM<br/> Yosemite National Park, CA" },
